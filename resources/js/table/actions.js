(function (window, document) {
	...
	tables.forEach(function (table) {
		...
		/**
		 * If the toggle all checkbox is clicked then toggle imprint it's checked status on ALL action toggles.
		 *
		 * @type {Element}
		 */
		...
		/**
		 * Enable and disable the table actions based on the toggles.
		 */
		checkboxes.forEach(function (checkbox) {
